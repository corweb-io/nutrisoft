...
jQuery(document).ready(function ($) {
  ...
  var Video_back = new video_background($("#home"), {
    ...
    mp4: "upload/preview_" + random + ".mp4", //Path to video mp4 format
    ogg: "upload/preview_" + random + ".ogg", //Path to video ogg format
    webm: "upload/preview_" + random + ".webm", //Path to video webm format
